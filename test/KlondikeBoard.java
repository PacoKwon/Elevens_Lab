...
public class KlondikeBoard
{
    ...
    private boolean isAlternated(List<CardInfo> selectedCards) {
        if (selectedCards.size() == 2) {
            ...
            /** Foundations에서 piles으로. If one is from a pile and another is from a foundation */
            ...
            /** Piles에서 foundations으로. If one is from a pile and another is from a foundation */
